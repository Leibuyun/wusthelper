...
public class WustyjsSpiderServiceImpl implements WustyjsSpiderService {
    ...
    public ResponseVO login(String username, String password) {
        ...
        } catch (BaseException e) { // 处理网络请求失败的情况, 包括账号密码正确和错误, 同样生成token
    ...
    public Map<String, String> downloadYzm() {
        ...
        try (FileOutputStream fileOutputStream = new FileOutputStream(fileName)) {
            ...
            throw new BaseException(ResponseCode.LOGIN_ERROR, "图片下载失败");
        }
...
//            ImageIO.write(bufferedImage, "png", new File(fileName));// 覆盖原来的图片
            ...
            throw new BaseException(ResponseCode.LOGIN_ERROR, "图片处理失败");
        } finally {
